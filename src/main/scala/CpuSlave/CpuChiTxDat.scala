...
// --------------------- Assertion ------------------------------- //
  ...
  assert(Mux(io.flit.valid, io.flit.bits.opcode === CHIOp.DAT.CopyBackWrData | io.flit.bits.opcode === CHIOp.DAT.SnpRespData, true.B), "Dont support opcode[%d] except CopyBackWrData", io.flit.bits.opcode)
